...
applies_to:
  ...
  - "tests/**"
  - "README.md"
summary: Lucy persists named JSONL sessions, interruption records, compaction boundaries, and an immutable boot-context snapshot on resume.
constrains: []
depends_on:
